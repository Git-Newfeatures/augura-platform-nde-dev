 ...
 * are the 19 tables below, each an array of rows: taxonomy_concepts,
 ...
 * dq_predicates, table_archetypes, dimension_kinds, affix_archetypes,
...
export const getStoredDqPredicates          = () => get('dq_predicates')
