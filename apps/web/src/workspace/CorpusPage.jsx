...
// POST /corpus/search : embed-on-server (le backend calcule l'embedding via la clé
// serveur) puis match vectoriel scopé tenant. Renvoie SearchHit[].
